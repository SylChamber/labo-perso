...
```text
# paquets additionnels
bash-completion cockpit-firewalld cockpit-selinux distrobox htop glibc-locale kubecolor patterns-microos-cockpit starship syncthing tree vim-small zsh zsh-htmldoc
```
